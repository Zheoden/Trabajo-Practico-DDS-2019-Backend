...
public class EmailSender implements NotificationManager {
	...
	@Override
	public void emailSend(String tipoServidor, Usuario user, Evento evento) {
		try {
			...
			messageBodyPart.setText("Se aproxima el evento " + evento.getNombre() + " en la fecha "
					+ evento.getFechaEvento() + " te sugiero que ");
