...
public class UsuarioTest {
	...
	public void todosPosiblesAtuendosPorGuardarropa() {
		...
		guardaRopas.add(guardaRopa1);
		guardaRopas.add(guardaRopa2);
		Usuario pepe = new Usuario("axelfulop@hotmail.com",guardaRopas, new SuscripcionPremium());
	...
	public void agregarPrendaAGuardaRopa() {
		...
		Usuario santi = new Usuario("axelfulop@hotmail.com",ropero, subs2);
	...
	public void agregarPrendaAGuardaRopa2() {
		...
		Usuario santi = new Usuario("axelfulop@hotmail.com",ropero2, subs4);
